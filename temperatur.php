<?php
require_once('../db.php');
$sql = "SELECT * FROM Temperatures ORDER BY Id";
$anzahleintraege;
if ($erg = $db->query($sql)) {
 	if ($erg->num_rows) {
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="temperatur.php">Temperatur Anzeige</a>
        </li>
        <li class="nav-item">
      ...
      <h3>Temperatur Daten</h3>
      <p>
         Hier findest du alle deine Gespeicherten Temperaturdaten: <?php print($ds_gesamt); ?>
         <form method="post" action="index.php">
   				<input type="submit" name="sent" value="Temperaturdaten Löschen">
   			</form>
      </p>
    </div>
    <div>
